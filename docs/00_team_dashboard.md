...
| Problem 3 | harvested main candidate + method portfolio | 한지후, 김승빈 | `docs/22_overnight_problem_3_evidence_handoff.md`, `docs/24_problem_3_method_portfolio.md` 기준으로 final notebook/report 반영 |
